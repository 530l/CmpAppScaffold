package com.lyf.cmpappscaffold.core.storage
 ...
 * - 必须在 [initPlatformStorage] 完成后才能构造（由启动链路保证：
 *   Application.onCreate / MainViewController 构造时即初始化，早于任何 Koin 解析）；
...
class MmkvKeyValueStore(
    ...
    private companion object {
        const val DEFAULT_MMAP_ID = "cmpappscaffold_common"
    }
}
